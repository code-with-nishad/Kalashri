...
import { formatDate, formatCurrency, glowPointsFromAmount } from "../../utils";
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="rounded-2xl bg-[var(--color-surface-card)] border border-[var(--color-border)] p-6 space-y-5">
          ...
          {appointment.services?.map(s => (
            <div key={s.serviceName} className="flex justify-between py-2 border-b border-[var(--color-border)] last:border-0">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="font-medium text-[var(--color-rose-400)]">{formatCurrency(s.price)}</span>
              </div>
            </div>
          ))}
        </div>
        <div className="flex justify-between pt-2 font-semibold">
          ...
          <span className="text-[var(--color-rose-400)] text-lg">{formatCurrency(appointment.totalAmount)}</span>
        </div>
