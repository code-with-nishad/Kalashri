  ...
  return (
    <div className="min-h-screen bg-[var(--color-surface)] pb-20">
      ...
      <div className="px-4 py-3 flex gap-2 overflow-x-auto no-scrollbar border-b border-gray-100">
        <span className="px-4 py-1.5 rounded-full bg-[var(--color-primary-dark)] text-white text-xs font-semibold whitespace-nowrap">All Types</span>
        <span className="px-4 py-1.5 rounded-full border border-gray-200 text-gray-600 text-xs font-medium whitespace-nowrap">4 Tax</span>
        <span className="px-4 py-1.5 rounded-full border border-gray-200 text-gray-600 text-xs font-medium whitespace-nowrap">1 Tax</span>
        <span className="px-4 py-1.5 rounded-full border border-gray-200 text-gray-600 text-xs font-medium whitespace-nowrap">Princess Cut</span>
      </div>
      ...
      <div className="p-4 grid grid-cols-2 gap-4">
        {types.map((type, i) => (
          <div key={i} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-[var(--color-border)] pb-3 text-center">
            <img src={type.img} alt={type.name} className="w-full h-32 object-cover mb-2" />
